...
import streamlit as st
icon_path = "youtube data harvesting"
st.set_page_config(
    page_title="Youtube Data Harvesting and Warehousing | By DEEPAK S A",
    page_icon=icon_path,
    layout="wide",
    initial_sidebar_state="expanded",
    menu_items={'About': """# This app is created by *DEEPAK SA!*"""}
)
...
with st.sidebar:
    selected = option_menu(None, ["Home", "Extract & Transform", "View"], 
                           ...
                           styles={"nav-link": {"font-size": "30px", "align-items": "center", "margin": "0px", 
                                                ":hover": {"color": "#C80101"}},
                                   "icon": {"font-size": "30px"},
